...
function memoryDocumentDebugMetadata(document: ChiliMemoryDocument): Record<string, unknown> {
...
async function projectRuleSources(dir: string, projectRoot: string): Promise<ChiliMemoryDocumentSource[]> {
...
function parseProjectRuleMarkdown(content: string): {
  body: string;
